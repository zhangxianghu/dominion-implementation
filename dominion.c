...
int card_smithy(int handPos, int currentPlayer, struct gameState *state) {
	int i;
	for (i = 0; i < 3; i++)
	{
...
int card_minion(struct gameState *state, int handPos, int currentPlayer, int choice1, int choice2) {
  	int i;
	int j;
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
	...
	/////////////////////////////////////////////////////////	
    case smithy:
		return card_smithy(handPos, currentPlayer, state);
    ...
    case minion:
		return card_minion(state, handPos, currentPlayer, choice1, choice2);
